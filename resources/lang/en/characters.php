...
return [
    ...
    /*
    |--------------------------------------------------------------------------
    | Characters Language Lines
    |--------------------------------------------------------------------------
    |
    | The following language lines are used in the characters pages.
    |
    */
    ...
    'add' => 'Add a character',
    'addSuccess' => 'Character successfully created',
    'editSuccess' => 'Character updated',
